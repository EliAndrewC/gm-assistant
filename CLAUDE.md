...
- `/gm-assistant/scripts/op_consent_census.py` - consent-first census of other people's L5R campaigns on Obsidian Portal (which owners allow bots); results stay gitignored. Code and its index in [`webapp/l7r/opcrawl/CLAUDE.md`](webapp/l7r/opcrawl/CLAUDE.md).
