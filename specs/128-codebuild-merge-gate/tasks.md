...
- [ ] T033 [US1] **FIRES**: an engine delta with an open task in the active feature's `tasks.md` is refused naming the tasks; with no active feature the condition passes (the Assumptions reading - do not widen it here)
