...
- [ ] T001 Wire the new module into the quality gates: add `scatter_audit` to `[tool.coverage.run] source` and to the mypy `files` list in `.claude/skills/diagram/pyproject.toml` (follow the `site_justice` rows; research.md R5)
