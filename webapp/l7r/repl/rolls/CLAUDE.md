...
| `sheet.py` | The character-sheet app's roll-history client. Those endpoints are **LIVE** since some point before 2026-09-20 (`app/routes/gm_api.py` there; measured against the deployed app). Every failure still degrades to empty with a reason; nothing raises. |
