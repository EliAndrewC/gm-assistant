---
name: vow
description: Generate oaths, vows, and sworn pledges for samurai, monks, and officials in the L5R setting
---

# Oaths and Vows

Generate oaths and vows consistent with the religious and political framework of Rokugan, for various orders, roles, and circumstances.
...
-> The Emperor spends approximately ~7-9 million koku per year on road upkeep, construction, waystation staffing, and the supporting infrastructure (see [`budgets.md` - The Imperial Budget](https://github.com/EliAndrewC/l7r/blob/master/setting/budgets.md#the-imperial-budget) for the detailed line-item breakdown).
...
(To be developed through iteration with the GM. This section will capture what the GM likes and dislikes about generated vows, and why.)
