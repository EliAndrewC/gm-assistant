...
shaved head and hair grown out from the tonsure - never a topknot, and a
rolled hair trait like an unusual haircut or balding skips the head roll
rather than contradict it), peasants get roughspun work clothes with no
swords and no topknot. The full
