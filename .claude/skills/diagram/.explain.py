...
print()
print("\033[1mreference settlement (Inashiro, seed 4):\033[0m", "CLEAN" if not bad else "FAILING")
if bad:
    print()
    ...
    if "features_do_not_overlap" in bad:
        ...
        for ln in s.M.get("lanes") or []:
            ...
            for w in s.M.get("wells") or []:
                ...
                if d2 < 40:
                    print(f"    -> a {kind} lane passes {d2:.1f} px from the well at ({w['x']:.0f}, {w['y']:.0f})")
    print()
