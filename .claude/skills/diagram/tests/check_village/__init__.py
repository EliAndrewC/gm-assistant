...
`tests/test_villages.py` confirms the real pool maps PASS every check (integration). This file
...
caught next time.
    ...
    python3 -m pytest tests/check_village/ -q
    python3 -m pytest tests/check_village/
"""
