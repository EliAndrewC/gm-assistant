...
**Grounds:** drives the size-audit PACKING / WHITESPACE sweep + [`pack_audit.py`](../pack_audit.py
...
**Grounds:** drives the LAYER/LABEL section of `pack_audit.py`; GM round of 2026-07
