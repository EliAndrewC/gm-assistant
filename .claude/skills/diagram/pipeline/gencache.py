...
HERE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # the SKILL ROOT, not this package: every path below is relative to it
    ...
    try:
        ...
        try:
            try:
                ...
                # 2026-08-08 `python3 -m pipeline.regen pool/*/*.gen.py` - the whole-pool invocation this
