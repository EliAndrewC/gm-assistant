...
Standalone run (from the skill dir): ``python3 -m pipeline.pool_index [--pool <dir>]``.
"""
...
SKILL_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # the skill root; this module lives in pipeline/
