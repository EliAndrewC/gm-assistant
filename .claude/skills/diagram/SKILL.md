...
The stroke convention is a visibility mechanism, **not a size license**: it never applies to anything with a drawable footprint. Relative sizes and distances stay proportional to reality - a thing twice as large (or twice as far) in the world reads roughly twice as large (or far) on the map. Hold proportions honest:
