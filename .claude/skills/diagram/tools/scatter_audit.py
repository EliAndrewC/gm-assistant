...
from settlement._geom import boxed_grid, boxed_hit, boxed_polys, boxed_seg_hit, boxed_segs
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not ns.map:
        print("usage: python3 -m tools.scatter_audit <pool-map-path> [--json]", file=sys.stderr)
        return 2
