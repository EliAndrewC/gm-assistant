...
directory's CLAUDE.md).
    ...
    python3 -m tools.crop_map pool/towns/hoshizora 1600,900,220 1200,400,150
    python3 -m tools.crop_map pool/hamlets/moritono --box 2100,150,2418,760 --zoom 1.7
    python3 -m tools.crop_map pool/villages/ueda --whole --zoom 0.5      # the whole map, downscaled
