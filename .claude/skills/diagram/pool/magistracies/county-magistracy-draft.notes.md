# county-magistracy-draft - design notes
...
Regenerate: `python3 compound.py pool/county-magistracy-draft.svg` (from the skill dir).
...
in the center, coverage lands in the jin'ya band (38%), and nothing overflows. It is a
...
Not run through building-review / size-audit as a finished map (it is a draft, not a
