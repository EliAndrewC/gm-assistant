...
**7 of this map's 20 farmhouses stood more than 100 ft from any way. Now none do** - the worst
is 93 ft and the median 42 ft - **and every lane on the sheet is one connected
...
runs PARALLEL to the field margin behind the ranks of plots, tied together by cross-links - the planned form the sources call a "rectangular framework", the one that says the place was LAID OUT. It carries **6 web lanes** of 10.
