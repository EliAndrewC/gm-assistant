...
is 77 ft, the median 44 - **and every lane on the sheet belongs to one connected
...
than a choice (Principle XII). This map rolled **`alleys`**, which narrow LATERALS threading back between columns of houses, hung off the skeleton - the accretive Chinese gridiron, the form that says the place GREW. It carries **8 web
lanes** of 12.
