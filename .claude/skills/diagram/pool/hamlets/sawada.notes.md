...
**10 of this map's 19 farmhouses stood more than 100 ft from any way. Now none do** - the worst
is 83 ft and the median 45 ft - **and every lane on the sheet is one connected
...
variance rather than a choice (constitution Principle XII). This map rolled **`alleys`**, which
narrow LATERALS threading back between columns of houses, hung off the skeleton - the accretive Chinese gridiron, the form that says the place GREW. It carries **7 web lanes** of 11.
