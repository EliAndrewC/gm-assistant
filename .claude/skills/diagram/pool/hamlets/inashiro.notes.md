...
**7 of this map's 15 farmhouses stood more than 100 ft from any way. Now none do** - the worst
is 96 ft, the median 58 - **and every lane on the sheet belongs to one connected
...
than a choice (Principle XII). This map rolled **`back_lane`**, which runs PARALLEL to the field margin behind the ranks of plots, tied to the rest by cross-links - the planned form the sources call a "rectangular framework", the one that says the place was LAID OUT. It carries **7 web
lanes** of 10.
