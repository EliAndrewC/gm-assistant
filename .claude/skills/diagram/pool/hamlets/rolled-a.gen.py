#!/usr/bin/env python3
"""Rolled-A - a village generated ENTIRELY from a seed (feature 005 US2, SC-004: zero hand-placed coords).
...
s.meta(name="Rolled-A", scale="hamlet", ftpx=1, toscale=True, households=18, field_footbridges=True)
knobs = s.roll_village("Rolled-A", households=18, down_deg=90, water_kind="pond", field_fall=1260)
print("rolled:", knobs)
print(s.finish(os.path.join(HERE, "rolled-a")))
