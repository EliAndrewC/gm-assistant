"""CLI entry: python3 -m check_village <manifest.json> [--capacity [--capacity-map]]."""

if __name__ == "__main__":
    import os
    import sys

    from check_village import QUARTER_DENSITY_CEIL, QUARTER_DENSITY_FLOOR, RESERVE_CAP_FRAC, city_capacity, main

    here = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # __file__ moved one level down into the package (feature 024)
