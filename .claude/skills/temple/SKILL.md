---
name: temple
description: Generate temples, monk NPCs, and temple daily life details for the L5R setting
---

# Temples

Generate temple descriptions, monk characters, and daily routines consistent with the Rokugan religious system. For relic generation, use the dedicated `/relic` skill.
