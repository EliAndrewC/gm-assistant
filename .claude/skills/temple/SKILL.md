---
name: temple
description: Generate temples, temple relics, monk NPCs, and temple daily life details for the L5R setting
---

# Temples

Generate temple descriptions, relics, monk characters, and daily routines consistent with the Rokugan religious system.

## Source Material - Temple Organization
...
- See `/cosmology/fortunes.md` for the 7 Major Fortunes and clan patronage
- See `/setting/professions.md` for monk population numbers
- See `/setting/demographics.md` for how temples fit into cities/towns
- See `/campaigns/karmic-inquisitors-temple.md` for the Temple of Bishamon's budget and daily routines (Kenta, Mizuki)
- See `/campaigns/damasu-temples.md` for the four temples of Toshi Ranbo
- See `/campaigns/temple-relics.md` for Chamber of Celestial Echoes and stolen relics
