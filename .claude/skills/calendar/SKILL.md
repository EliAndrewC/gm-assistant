---
name: calendar
description: Generate seasonal details, festival descriptions, and agricultural events for the Rokugani calendar
---

# Rokugani Calendar

Generate seasonal content, festival details, and agricultural events consistent with the Rokugani 360-day solar year and 30-day lunar months.
...
(To be developed through iteration with the GM. This section will capture what the GM likes and dislikes about generated calendar content, and why.)

## References

- See `/setting/demographics.md` for how seasonal events affect different population levels
- See `/setting/economics.md` for how agricultural cycles tie to the tax/rent system
