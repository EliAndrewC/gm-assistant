---
name: The Sashimono of Matsu Kenzou
...
On the anniversary of the Pass of White Stones, the Custodian performs the **Reading of the Stain**. The banner is lifted from its niche and examined by lamplight; the dark patch on its lower third is studied for any new color the year may have brought. The temple's records, kept for three centuries, note that the stain has sometimes deepened in years of heavy fighting and sometimes faded slightly in years of peace. The Custodian records the year's observation alongside the previous entries and replaces the banner. The pattern across the centuries is read as Kenzou's report on the temper of the times - though Kenzou speaks in his own time, and the report is rarely understood at once.

The sashimono cannot leave the temple. A captain who marches beneath it carries Kenzou's strength out into the field; the banner itself stays behind so that the next captain may also pass beneath. To carry the banner into battle would be to spend Kenzou's blessing on a single engagement, and the temple has been firm on this point in every generation, even when commanders of high rank have asked.
