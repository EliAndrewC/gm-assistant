---
name: fortune
description: Generate omens, portents, soothsaying results, and Fortune theology content for the L5R setting
---

# Fortunes and Soothsaying

Generate omens, portents, prophecies, and theological content consistent with the Rokugani religious framework.

## Source Material - Soothsaying

<!-- SOURCE: GM NOTES - DO NOT MODIFY -->
SOOTHSAYING:

As mentioned above, various omens and portents in the Karmic Inqusitors campaign should have foretold of the kumosaya fungal blight.  Let's talk about omens and portents in Rokugan, and how they are understood as tools of soothsaying.
...
## Source Material - Fortune Theology
...
(To be developed through iteration with the GM. This section will capture what the GM likes and dislikes about generated cosmological content, and why.)

## References

- See `/cosmology/fortunes.md` for the full Fortunes source material (same text as above, canonical location)
- See `/cosmology/moon-court.md` for Lord Moon's heavenly court
- See `/cosmology/between-places.md` for supernatural locations and their effects
- See `/setting/government.md` for Ministry of Rites (administers religious institutions)
